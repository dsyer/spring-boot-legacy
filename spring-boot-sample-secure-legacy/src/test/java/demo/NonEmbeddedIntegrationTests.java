...
public class NonEmbeddedIntegrationTests {
	...
	public void testVersion() throws IOException {
		String body = new TestRestTemplate()
				.getForObject("http://localhost:" + port + "/info", String.class);
	...
	public void testSecure() throws IOException {
		ResponseEntity<String> body = new TestRestTemplate()
				.getForEntity("http://127.0.0.1:" + port + "/", String.class);
		assertEquals("Wrong body: " + body, HttpStatus.UNAUTHORIZED,
				body.getStatusCode());
	}
